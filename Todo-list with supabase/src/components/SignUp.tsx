...
function SignUp({ showSign }: showSignType) {
  ...
  return (
    <>
      <h2 className="font-bold text-4xl text-center pb-12">Welcome!</h2>
      <GoogleSign />
      ...
      <form className="space-y-4 max-w-xs mx-auto" onSubmit={handleSignUp}>
